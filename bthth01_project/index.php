...
<body>
    <header>
        <nav class="navbar navbar-expand-lg bg-primary text-white shadow p-3 bg-light rounded">
    ...
    <footer class="bg-light d-flex justify-content-center align-items-center border-top border-secondary  border-2" style="height:80px">
